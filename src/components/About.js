...
const info = {
    ...
    baseColor: colors[0],
    bio: "Hello! I'm Brian. I'm a Principal Program Manager for Whole Foods Market. I studied Economics at Colgate, and recently became a full stack web developer! ",
    skills: {
    proficientWith: [
      "javascript",
      "react",
